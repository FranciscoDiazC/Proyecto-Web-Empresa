    ...
    <section className="relative mt-16 w-full h-[500px] "> {/* pt-16, para que el navbar que mide 4rem no tape el herosection */}
      ...
      lg:max-w-[40%]">
        ...
        <a
          ...
          <div className="flex flex-row items-center gap-4 bg-card rounded-xl px-8 border-2 border-border drop-shadow-[0px_0px_10px_rgba(255,255,255,0.75)]">
          <div className="text-[clamp(1.3rem,2.5vw,1.65rem)] text-card-foreground font-bold">
